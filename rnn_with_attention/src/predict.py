...
#    from example_predictor import ExamplePredictor
    ...
    config['model_parameters']['network'] = args.network
    ...
    output_path = os.path.join(args.predict_path)
...
def _parse_args():
    ...
    parser.add_argument('predict_path', type=str,
                        help='Directory to save the predict file.')
    parser.add_argument('--network', type=str,
                        help='The network you want to use')
    parser.add_argument('--model', type=str,
                        help='The model your network correspond')
