...
class BasePredictor():
    ...
    def fit_dataset(self, data, collate_fn=default_collate, callbacks=[]):
        ...
        while self.epoch < self.max_epochs:
            ...
            if self.valid is not None:
                ...
                # and `collate_fn=collate_fn`.
                # evaluate model
                dataloader = DataLoader(self.valid, batch_size=self.batch_size, collate_fn=collate_fn, shuffle=False)
    ...
    def predict_dataset(self, data,
        ...
        # and `collate_fn=collate_fn`.
        # evaluate model
        dataloader = DataLoader(data, batch_size=self.batch_size, collate_fn=collate_fn, shuffle=False)
